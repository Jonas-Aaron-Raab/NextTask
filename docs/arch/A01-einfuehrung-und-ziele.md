...
Der fachliche Kern in einem Absatz: Ein Anwender meldet sich mit E-Mail und Passwort an, optional mit Einmalcode aus einer Authenticator-App, oder über den Identity Provider der Sparkasse. Er sieht die Abteilungen, Projekte, Aufgaben und Dokumente seines Sichtbereichs, den der Server aus seiner Zugriffsrolle ableitet, bearbeitet Aufgaben im Kanban-Board und im Backlog, terminiert sie im Kalender und kommentiert sie. Fristen gehen als Termin in seinen Google-Kalender, Zuweisungen und Erwähnungen als E-Mail. Für kritische Schritte stellt er eine Freigabeanfrage, die eine zweite Person entscheidet. Projektleitungen pflegen Meilensteine, Risiken, Budget und Schnittstellen und erzeugen daraus einen dreiseitigen Statusbericht als PDF; ein Abteilungsbericht lässt sich als PDF oder CSV exportieren. Administratoren pflegen Abteilungen, Rollen und Benutzer und lesen das Audit-Log, in dem jede ändernde Aktion mit Vorher-Nachher-Werten steht.
