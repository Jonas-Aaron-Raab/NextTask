...
| 0.5.1 | 2026-09-24 | Nach den Server-Änderungen vom Abend: Anfragender kann die eigene Anfrage nicht entscheiden (SC-02, UC-19, AF-03, DLG-08, QK-02); einheitliche Anmeldemeldung, Mindestlänge des Passworts an allen Stellen, Rollen mit Benutzern nicht löschbar (R-04 behoben), Adresse der Schnittstelle über `VITE_API_URL` (N1, B1, S3, N2, UC-01, UC-21, UC-22); Schnittstellentests in S3 genannt. |
